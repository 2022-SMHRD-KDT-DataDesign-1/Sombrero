<%@page import="com.som.model.ProductsVO"%>
<%@page import="java.util.List"%>
<%@page import="com.som.model.ProductsDAO"%>
...
<body class="animsition">
	...
	<%
		...
		List<ProductsVO> productsList = p_dao.showProducts();
	...
	%>
			...
			<% for(ProductsVO p : productsList){%>
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <%=p.getCate_seq() %>">
					<!-- Block2 -->
					<div class="block2">
...
<!-- 				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item hiking">
					Block2
					<div class="block2">
						<div class="block2-pic hov-img0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item fishing">
					Block2
					<div class="block2">
						<div class="block2-pic hov-img0">
